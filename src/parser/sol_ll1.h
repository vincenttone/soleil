...
int solLL1Parser_reg_sign(SolLL1Parser*, SolLL1ParserSign*);
SolLL1ParserSign* solLL1Parser_reg_terminal(SolLL1Parser*, void*);
SolLL1ParserSign* solLL1Parser_reg_nonterminal(SolLL1Parser*, void*);
...
void _solLL1ParserSign_free(void*);
