...
typedef struct SolNfa {
	SolNfaRuleBook *book;
	SolSet *current_state;
	SolSet *accept_states;
} SolNfa;
...
SolSet* solNfa_current_states(SolNfa*);
...
SolSet* solNfaRuleBook_follow_rules(SOL_FA_STATE, SOL_FA_CHARACTER);
SolSet* solNfaRuleBook_next_states(SolNfaRuleBook*, SolSet*, SOL_FA_CHARACTER);
